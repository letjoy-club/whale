...
var (
	...
	ErrDeadlineBeforeNow         = midacode.NewError("DEADLINE_BEFORE_NOW", "截止时间不能早于当前时间", midacode.LogLevelWarn)
	ErrDeadlineTooLong           = midacode.NewError("DEADLINE_TOO_LONG", "截止时间不能超过 7 天", midacode.LogLevelWarn)
	ErrImageEmpty                = midacode.NewError("IMAGE_EMPTY", "图片不能为空", midacode.LogLevelWarn)
	ErrImageNumExceedLimit       = midacode.NewError("IMAGE_NUM_EXCEED_LIMIT", "图片数量超过限制", midacode.LogLevelWarn)

	ErrLatLngOutOfRange                             = midacode.NewError("LAT_LNG_OUT_OF_RANGE", "坐标超出范围", midacode.LogLevelWarn)
	ErrYouAreAlreadyInEvent                         = midacode.NewError("YOU_ARE_ALREADY_IN_EVENT", "你已经在活动中", midacode.LogLevelWarn)
	ErrEventProposalClosed                          = midacode.NewError("EVENT_PROPOSAL_CLOSED", "活动已关闭", midacode.LogLevelWarn)
	ErrEventProposalNotExisted                      = midacode.NewError("EVENT_PROPOSAL_NOT_EXISTED", "活动不存在", midacode.LogLevelWarn)
	...
	ErrTheMotionIsNotActive                         = midacode.NewError("THE_MOTION_IS_NOT_ACTIVE", "对方的活动已关闭", midacode.LogLevelWarn)
